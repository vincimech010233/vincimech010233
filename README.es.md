...
| **[Contribuciones Open Source](open-source-contributions/README.es.md)** | [StockVeda PR #74](https://github.com/CRS5226/StockVeda/pull/74) — corrección de seguridad en la API, fusionada; la persona mantenedora confirmó que cerró dos alertas de CodeQL por exposición de trazas |
...
| **[Ciberseguridad / SOC](ciberseguridad/README.md)** | [Defensive Security Lab](https://github.com/vincimech010233/cibersecurity) (analizador de logs simulados con pruebas automáticas y CI) |
...
- Procesamiento, transformación e informes de datos
- Scripting de seguridad defensiva y análisis de registros
- Investigación en fuentes abiertas y documentación técnica
- Cálculo científico y de ingeniería
