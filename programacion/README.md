...
- [simdjson Streaming Complexity Study](https://github.com/vincimech010233/simdjson-streaming-complexity-study) — estudio reproducible en C++ y Python del parseo JSON en streaming, con grupos de control, ejecución limitada por recursos y evaluación de una anomalía inicial que no se reprodujo en las muestras adicionales.
...
- [Computación neuromórfica](neuromorphic-computing.md) — borrador sobre evaluación de procesamiento dirigido por eventos.
- [World models](world-models.md) — marco para comparativas reproducibles de arquitecturas.

Estas notas son independientes y no presentan resultados experimentales propios.
